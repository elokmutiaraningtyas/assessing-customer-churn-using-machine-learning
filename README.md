...
* **Next Steps:** Future improvements should focus on handling data imbalance (e.g., SMOTE or clasz weighting) to help the model better catch customers who are about to leave
